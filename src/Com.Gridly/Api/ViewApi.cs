...
namespace Com.Gridly.Api
{
    ...
    public interface IViewApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Object> ExportAsync(string viewId, List<string> columnIds = default(List<string>), string query = default(string), string sort = default(string), string type = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ExportWithHttpInfoAsync(string viewId, List<string> columnIds = default(List<string>), string query = default(string), string sort = default(string), string type = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// get
        /// </summary>
        /// <remarks>
    ...
    public partial class ViewApi : IViewApi
    {
        ...
        {
            Com.Gridly.Client.ApiResponse<Object> localVarResponse = ExportWithHttpInfo(viewId, columnIds, query, sort, type);
        ...
        /// <param name="type">type (optional, default to csv)</param>
        /// <returns>ApiResponse of Object</returns>
        public Com.Gridly.Client.ApiResponse<Object> ExportWithHttpInfo(string viewId, List<string> columnIds = default(List<string>), string query = default(string), string sort = default(string), string type = default(string))
        {
            ...
            var localVarResponse = this.Client.Get<Object>("/v1/views/{viewId}/export", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> ExportAsync(string viewId, List<string> columnIds = default(List<string>), string query = default(string), string sort = default(string), string type = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Gridly.Client.ApiResponse<Object> localVarResponse = await ExportWithHttpInfoAsync(viewId, columnIds, query, sort, type, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Com.Gridly.Client.ApiResponse<Object>> ExportWithHttpInfoAsync(string viewId, List<string> columnIds = default(List<string>), string query = default(string), string sort = default(string), string type = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'viewId' is set
            if (viewId == null)
                throw new Com.Gridly.Client.ApiException(400, "Missing required parameter 'viewId' when calling ViewApi->Export");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/v1/views/{viewId}/export", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
