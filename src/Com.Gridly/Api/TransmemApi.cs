...
namespace Com.Gridly.Api
{
    ...
    public interface ITransmemApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void ImportTmx(string tmId, Object file, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> ImportTmxWithHttpInfo(string tmId, Object file, int operationIndex = 0);
        /// <summary>
    ...
    public interface ITransmemApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ImportTmxAsync(string tmId, Object file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> ImportTmxWithHttpInfoAsync(string tmId, Object file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all available translation memories or create default one if there is no translation memory
        /// </summary>
        /// <remarks>
    ...
    public partial class TransmemApi : ITransmemApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void ImportTmx(string tmId, Object file, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Com.Gridly.Client.ApiResponse<Object> ImportTmxWithHttpInfo(string tmId, Object file, int operationIndex = 0)
        {
            // verify the required parameter 'tmId' is set
            if (tmId == null)
            {
            ...
            localVarRequestOptions.PathParameters.Add("tmId", Com.Gridly.Client.ClientUtils.ParameterToString(tmId)); // path parameter
            localVarRequestOptions.FormParameters.Add("file", Com.Gridly.Client.ClientUtils.Serialize(file)); // form parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ImportTmxAsync(string tmId, Object file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Com.Gridly.Client.ApiResponse<Object>> ImportTmxWithHttpInfoAsync(string tmId, Object file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tmId' is set
            if (tmId == null)
            {
