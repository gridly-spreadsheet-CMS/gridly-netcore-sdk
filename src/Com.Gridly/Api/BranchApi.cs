...
namespace Com.Gridly.Api
{
    ...
    public interface IBranchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Branch> CreateAsync(CreateBranch createBranch, string branchId = default(string), string gridId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Branch>> CreateWithHttpInfoAsync(CreateBranch createBranch, string branchId = default(string), string gridId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// delete
        /// </summary>
        /// <remarks>
    ...
    public partial class BranchApi : IBranchApi
    {
        ...
        {
            Com.Gridly.Client.ApiResponse<Branch> localVarResponse = CreateWithHttpInfo(createBranch, branchId, gridId);
        ...
        /// <param name="gridId">gridId (optional)</param>
        /// <returns>ApiResponse of Branch</returns>
        public Com.Gridly.Client.ApiResponse<Branch> CreateWithHttpInfo(CreateBranch createBranch, string branchId = default(string), string gridId = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Branch</returns>
        public async System.Threading.Tasks.Task<Branch> CreateAsync(CreateBranch createBranch, string branchId = default(string), string gridId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Gridly.Client.ApiResponse<Branch> localVarResponse = await CreateWithHttpInfoAsync(createBranch, branchId, gridId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Branch)</returns>
        public async System.Threading.Tasks.Task<Com.Gridly.Client.ApiResponse<Branch>> CreateWithHttpInfoAsync(CreateBranch createBranch, string branchId = default(string), string gridId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createBranch' is set
            if (createBranch == null)
            {
