...
namespace Com.Gridly.Api
{
    ...
    public interface IBranchApiSync : IApiAccessor
    {
        ...
        Task Merge(string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), int operationIndex = 0);
        ...
        ApiResponse<Task> MergeWithHttpInfo(string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), int operationIndex = 0);
    ...
    public interface IBranchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Task> MergeAsync(string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Task>> MergeWithHttpInfoAsync(string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BranchApi : IBranchApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Task</returns>
        public Task Merge(string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), int operationIndex = 0)
        {
            Com.Gridly.Client.ApiResponse<Task> localVarResponse = MergeWithHttpInfo(branchId, destinationBranchId, mergeRecordOptions);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Task</returns>
        public Com.Gridly.Client.ApiResponse<Task> MergeWithHttpInfo(string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), int operationIndex = 0)
        {
            // verify the required parameter 'branchId' is set
            if (branchId == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Task</returns>
        public async System.Threading.Tasks.Task<Task> MergeAsync(string branchId, string destinationBranchId, List<string> mergeRecordOptions = default(List<string>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Gridly.Client.ApiResponse<Task> localVarResponse = await MergeWithHttpInfoAsync(branchId, destinationBranchId, mergeRecordOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
